...
- **Freshness**: Every time-sensitive value (prices, availability, measured performance, rankings, statistics, schedules, current versions) MUST carry the date of the source it came from, e.g. "$4,349 (vendor store, July 2026)". If the source gives no date, mark it "(undated)"; a bare time-sensitive figure with no date is not acceptable. Label anything from a source older than 3 months as "may be outdated". When two figures for the same metric differ, differing dates are often the explanation — surface both with their dates rather than treating differently-dated measurements as a contradiction to resolve.
